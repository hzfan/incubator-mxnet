...
def test_add():
    ...
    m = 256
    k = 256
    # print("tvm 1024 add:")  # tvm 1024 add: cost: 7.359095573425293 ms
    ...
    # print("tvm 1024 add_1024:")   # cost: 7.334786891937256 ms
    # a = mx.nd.random.uniform(shape=(n, m, k), dtype='float32')
    # b = mx.nd.random.uniform(shape=(n, m, k), dtype='float32')
    # cost = measure_cost(500, mx.nd.contrib.tvm_vadd_1024, a, b)
    # print("cost: {} ms".format(cost * 1000))
    # print("tvm 1023 add:")
    # n = 255
    # m = 255
    ...
    # b = mx.nd.random.uniform(shape=(n, m, k), dtype='float32')
    # cost = measure_cost(500, mx.nd.contrib.tvm_vadd, a, b)
    # print("cost: {} ms".format(cost * 1000)) cost: 7.740177154541016 ms
    print("tvm 1025 add:")
    n = 257
    m = 257
    k = 257
